...
function alkautsar_companion_backup_reminder() {
	...
	if ( is_plugin_active( 'updraftplus/updraftplus.php' ) || is_plugin_active( 'wpvivid-backuprestore/wpvivid-backuprestore.php' ) || is_plugin_active( 'backwpup/backwpup.php' ) ) {
...
/**
 * Helper: check if plugin is active (with safety).
 */
