...
function alkautsar_companion_demo_menu() {
	add_submenu_page(
		'alkautsar-companion',
		'Install Demo Content',
		'Install Demo',
		'manage_options',
		'alkautsar-companion-demo',
		'alkautsar_companion_demo_page'
	);
}
add_action( 'admin_menu', 'alkautsar_companion_demo_menu' );

function alkautsar_companion_demo_page() {
	...
	<div class="wrap">
		...
		<?php if ( '1' === $installed ) : ?>
			<div class="notice notice-success is-dismissible">
				<p><strong>Berhasil!</strong> Demo content berhasil diinstall. Silakan lihat menu Berita, Kegiatan, Program di sidebar.</p>
			</div>
		<?php endif; ?>

		<p>Halaman ini akan menginstall contoh konten lengkap untuk Masjid Al-Kautsar:</p>
		<ul style="list-style:disc; padding-left:20px;">
			<li><strong>5 Berita &amp; Informasi</strong> (Kajian, Buka Puasa, Pendaftaran TPA, Pengajian Akbar, Santunan)</li>
			<li><strong>4 Kegiatan Mendatang</strong> (Kajian Bulughul Maram, Buka Puasa Bersama, Pendaftaran TPA, Maulid Nabi)</li>
			<li><strong>6 Program</strong> (Kajian Rutin, TPA, Santunan, Jumat Berkah, Pelatihan, Konsultasi)</li>
			<li><strong>4 Laporan Keuangan</strong> (Bulanan Jan-Feb 2026 + Harian contoh)</li>
			<li><strong>3 Penerima Manfaat</strong> (contoh yatim, dhuafa, janda)</li>
		</ul>

		<p style="background:#fff4e5; border-left:4px solid #E07B00; padding:12px 16px; border-radius:4px;">
			<strong>Catatan:</strong> Demo content aman diinstall. Tidak akan menimpa konten yang sudah ada. Anda bisa edit/hapus setelah install.
		</p>
...
function alkautsar_companion_handle_install_demo() {
	...
	wp_safe_redirect( admin_url( 'admin.php?page=alkautsar-companion-demo&installed=1' ) );
	exit;
}
